...
export default function LoveSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(155deg, #2e2820 0%, #3d2e22 50%, #2e2820 100%)",
      }}
    >
      {/* Ambient glows */}
      ...
      <div ref={ref} className="relative z-10 max-w-3xl mx-auto text-center">
        {/* Label */}
        <p
          className="font-cinzel tracking-[0.38em] text-goldlt/60 uppercase"
        ...
        >
          {/* Corner accents */}
          <span className="absolute top-3 left-4 text-gold/30 font-monte text-2xl">
            ❝
          </span>
          <span className="absolute bottom-3 right-4 text-gold/30 font-monte text-2xl">
            ❞
          </span>
          {/* 
          <p
          ...
          <p
            ...
            style={{ fontSize: "clamp(1rem, 2.2vw, 1.25rem)" }}
          >
            With joy and sincere pleasure, we
            <span className="text-goldlt not-italic">{" "}invite {" "}</span>
            you to join us in celebrating a special beginning. As two lives come
            together in love and commitment, this evening marks the start of a
            beautiful journey shared side by side.
          </p>
          ...
          <p
            ...
            style={{ fontSize: "clamp(1rem, 2.2vw, 1.25rem)" }}
          >
            Surrounded by those who matter most, we gather to honour this moment
            and create memories to be cherished. Your presence will truly add to
            the elegance and warmth of this occasion.
          </p>
        </div>
        ...
        <div className={`mt-8 reveal reveal-d4 ${visible ? "in-view" : ""}`}>
          <p
            className="font-monte text-gold/70"
            style={{ fontSize: "clamp(1.6rem, 4vw, 2.4rem)" }}
          >
            With all our love
          </p>
          <p
            className="font-cinzel tracking-[0.25em] text-cream/30 mt-1"
            style={{ fontSize: "0.5rem" }}
          >
            The Families of Hatem &amp; Habiba
          </p>
        </div>
      </div>
    </section>
